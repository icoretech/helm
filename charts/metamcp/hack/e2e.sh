...
kubectl -n "$NS" logs -l app.kubernetes.io/component=server,mcp.icore.tech/server=http-everything --tail=120 || true
kubectl -n "$NS" logs -l app.kubernetes.io/component=server,mcp.icore.tech/server=sse-everything --tail=120 || true
echo "# Done"
